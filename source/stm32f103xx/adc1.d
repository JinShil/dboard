...
*/
final abstract class ADC1 : Peripheral!(0x40012400)
{
    /*************************************************************************
     status register
    */
    ...
    final abstract class CR1 : Register!(0x4)
    {
        ...
        */
        ...
        /*********************************************************************
         Dual mode selection
        */
        alias DUALMOD = BitField!(19, 16, Mutability.rw);
    ...
    final abstract class DR : Register!(0x4c)
    {
        ...
        */
        ...
        /*********************************************************************
         ADC2 data
        */
        alias ADC2DATA = BitField!(31, 16, Mutability.rw);
    }
}
