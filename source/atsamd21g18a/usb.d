...
final abstract class USB : Peripheral!(0x41005000)
{
    ...
    */
    final abstract class DEVICE : Peripheral!(0x41005000)
    {
        ...
        */
        final abstract class EPCFG(ubyte n) : Register!(0x100 + (n * 0x20))
        {
            /*********************************************************************
             End Point Type0
            */
        ...
        */
        final abstract class EPSTATUSCLR(ubyte n) : Register!(0x104 + (n * 0x20))
        {
            /*********************************************************************
        ...
        */
        final abstract class EPSTATUSSET(ubyte n) : Register!(0x104 + (n * 0x20))
        {
            /*********************************************************************
             Data Toggle OUT Set
            */
            alias DTGLOUT = Bit!(8 + 0, Mutability.w);

            /*********************************************************************
             Data Toggle IN Set
            */
            alias DTGLIN = Bit!(8 + 1, Mutability.w);

            /*********************************************************************
             Current Bank Set
            */
            alias CURBK = Bit!(8 + 2, Mutability.w);

            /*********************************************************************
             Stall 0 Request Set
            */
            alias STALLRQ0 = Bit!(8 + 4, Mutability.w);

            /*********************************************************************
             Stall 1 Request Set
            */
            alias STALLRQ1 = Bit!(8 + 5, Mutability.w);

            /*********************************************************************
             Bank 0 Ready Set
            */
            alias BK0RDY = Bit!(8 + 6, Mutability.w);

            /*********************************************************************
             Bank 1 Ready Set
            */
            alias BK1RDY = Bit!(8 + 7, Mutability.w);
        }
        ...
        */
        final abstract class EPSTATUS(ubyte n) : Register!(0x104 + (n * 0x20))
        {
            /*********************************************************************
             Data Toggle Out
            */
            alias DTGLOUT = Bit!(16 + 0, Mutability.r);

            /*********************************************************************
             Data Toggle In
            */
            alias DTGLIN = Bit!(16 + 1, Mutability.r);

            /*********************************************************************
             Current Bank
            */
            alias CURBK = Bit!(16 + 2, Mutability.r);

            /*********************************************************************
             Stall 0 Request
            */
            alias STALLRQ0 = Bit!(16 + 4, Mutability.r);

            /*********************************************************************
             Stall 1 Request
            */
            alias STALLRQ1 = Bit!(16 + 5, Mutability.r);

            /*********************************************************************
             Bank 0 ready
            */
            alias BK0RDY = Bit!(16 + 6, Mutability.r);

            /*********************************************************************
             Bank 1 ready
            */
            alias BK1RDY = Bit!(16 + 7, Mutability.r);
        }
        ...
        */
        final abstract class EPINTFLAG(ubyte n) : Register!(0x104 + (n * 0x20))
        {
            /*********************************************************************
             Transfer Complete 0
            */
            alias TRCPT0 = Bit!(24 + 0, Mutability.rw);

            /*********************************************************************
             Transfer Complete 1
            */
            alias TRCPT1 = Bit!(24 + 1, Mutability.rw);

            /*********************************************************************
             Error Flow 0
            */
            alias TRFAIL0 = Bit!(24 + 2, Mutability.rw);

            /*********************************************************************
             Error Flow 1
            */
            alias TRFAIL1 = Bit!(24 + 3, Mutability.rw);

            /*********************************************************************
             Received Setup
            */
            alias RXSTP = Bit!(24 + 4, Mutability.rw);

            /*********************************************************************
             Stall 0 In/out
            */
            alias STALL0 = Bit!(24 + 5, Mutability.rw);

            /*********************************************************************
             Stall 1 In/out
            */
            alias STALL1 = Bit!(24 + 6, Mutability.rw);
        }
        
        /*************************************************************************
         DEVICE End Point Interrupt Clear Flag
        */
        final abstract class EPINTENCLR(ubyte n) : Register!(0x108 + (n * 0x20))
        {
            /*********************************************************************
        ...
        */
        final abstract class EPINTENSET(ubyte n) : Register!(0x108 + (n * 0x20))
        {
            /*********************************************************************
             Transfer Complete 0 Interrupt Enable
            */
            alias TRCPT0 = Bit!(8 + 0, Mutability.rw);

            /*********************************************************************
             Transfer Complete 1 Interrupt Enable
            */
            alias TRCPT1 = Bit!(8 + 1, Mutability.rw);

            /*********************************************************************
             Error Flow 0 Interrupt Enable
            */
            alias TRFAIL0 = Bit!(8 + 2, Mutability.rw);

            /*********************************************************************
             Error Flow 1 Interrupt Enable
            */
            alias TRFAIL1 = Bit!(8 + 3, Mutability.rw);

            /*********************************************************************
             Received Setup Interrupt Enable
            */
            alias RXSTP = Bit!(8 + 4, Mutability.rw);

            /*********************************************************************
             Stall 0 In/out Interrupt enable
            */
            alias STALL0 = Bit!(8 + 5, Mutability.rw);

            /*********************************************************************
             Stall 1 In/out Interrupt enable
            */
            alias STALL1 = Bit!(8 + 6, Mutability.rw);
        }
    }
    /*****************************************************************************
     USB is Host
